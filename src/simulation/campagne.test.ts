    ...
    expect(JSON.parse(JSON.stringify(etat))).toEqual({
      ...
      routes: expect.objectContaining({
        ...
        etatsReels: {
          ...
          "arc-ferroviaire-du-noeud": "degrade",
          "galerie-des-trois-phares": "degrade",
          "porte-logistique-du-seuil": "degrade",
          "passage-de-la-couronne-ouverte": "praticable",
          "breche-de-secours-du-noeud": "degrade",
        },
        engagements: [],
        jalons: [],
      }),
