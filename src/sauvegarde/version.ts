...
export const VERSION_SAUVEGARDE_AVANT_EXTINCTION_DU_PHARE = 15 as const;
export const VERSION_SAUVEGARDE_AVANT_CALIBRAGE_CAUSAL = 16 as const;
export const VERSION_SAUVEGARDE_COURANTE = 17 as const;
