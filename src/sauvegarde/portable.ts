...
export function importerSauvegarde(
  ...
  if (version === VERSION_SAUVEGARDE_AVANT_RECUPERATIONS) {
    const sauvegarde = migrerSauvegardeV11(valeur);
    return sauvegarde === undefined
      ? {
          statut: "invalide",
          archiveOriginale,
  ...
  if (version === VERSION_SAUVEGARDE_AVANT_CRISES_SEQUENTIELLES) {
    const sauvegarde = migrerSauvegardeV12(valeur);
    return sauvegarde === undefined
      ? {
          statut: "invalide",
          archiveOriginale,
          explication:
            "La sauvegarde v12 est incomplète, altérée ou diverge lors du replay.",
        }
      : {
          statut: "migree",
          sauvegarde,
  ...
  if (version === VERSION_SAUVEGARDE_AVANT_CRISE_DE_TRAME) {
    const sauvegarde = migrerSauvegardeV13(valeur);
    return sauvegarde === undefined
      ? {
          statut: "invalide",
          archiveOriginale,
          explication:
            "La sauvegarde v13 est incomplète, altérée ou diverge lors du replay.",
        }
      : {
          statut: "migree",
          sauvegarde,
  ...
  if (version === VERSION_SAUVEGARDE_AVANT_CRISE_DU_HALO) {
    const sauvegarde = migrerSauvegardeV14(valeur);
    return sauvegarde === undefined
      ? {
          statut: "invalide",
          archiveOriginale,
          explication:
            "La sauvegarde v14 est incomplète, altérée ou diverge lors du replay.",
        }
      : {
          statut: "migree",
          sauvegarde,
  ...
  if (version === VERSION_SAUVEGARDE_AVANT_CALIBRAGE_CAUSAL) {
    const sauvegarde = migrerSauvegardeV16(valeur);
    return sauvegarde === undefined
      ? {
          statut: "invalide",
          archiveOriginale,
  ...
  return sauvegarde === undefined
    ? {
        ...
        archiveOriginale,
        explication:
          "La sauvegarde v17 est incomplète, altérée ou diverge lors du replay.",
      }
